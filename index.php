...
if (isset($_POST['submit'])) {
    ...
    if ($appdate <= $cdate) {
        ...
        $sql = "insert into tblappointment(AppointmentNumber,Name,MobileNumber,Email,AppointmentDate,AppointmentTime,Specialization,Doctor,age,Message)values(:aptnumber,:name,:mobnum,:email,:appdate,:aaptime,:specialization,:doctorlist,:age,:message)";
...
<head>
    <title>Rendez-vous chez l'orthophoniste || Home Page</title>
                        ...
                        <div class="booking-form">
                            ...
                            <form role="form" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <input type="date" name="age" id="age" value="" placeholder="Votre Date de naissance" class="form-control">
